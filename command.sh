...
do
    CUDA_DEVICE_ORDER=PCI_BUS_ID CUDA_VISIBLE_DEVICES=4 python ${bert_forecast}\
        ...
        --corpus_name ${corpus}\
        --random_seed ${seed}\
        --output_dir "/home/sqt2/myExperiment/cs6742-trama/${corpus}/${seed}"
done
