...
%         \hline
%         \multicolumn{1}{|c|}{ \textbf{Conversation} } & \multicolumn{1}{c|}{ \textbf{\textit{Labels \&}} }\\
%         & \multicolumn{1}{c|}{ \textit{\textbf{Forecasts}} }\\
%         \hline
%         \textbf{\textit{(1) User1:}} There have been 45 consecutive male presidents and 0 female ones. This gender ratio is extremely imbalanced, [...]

%         \textbf{\textit{(2) User2:}} Women have had the right to vote for many decades and yet they all voted men into office. 
%         & Label: \textcolor{red}{Awry}
        
%         Normal: \textcolor{red}{Awry}
...
%         & Label: \textcolor{teal}{Calm}
        
%         Normal: \textcolor{teal}{Calm}
